    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard') ?>">
                 <img class="img-profile" width="190" height="60"src="<?php echo base_url('assets/img/logo.png') ?>">
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/perlengkapan_bayi') ?>">
                    <i class="fas fa-baby-carriage"></i>
                    <span>Perlengkapan Bayi</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="sidebar-brand-text mx-1"><h4><b>Tsarwah Shop</b></h4></div>
